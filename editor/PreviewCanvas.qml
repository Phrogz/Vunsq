...
Item {
    ...
    Canvas {
        ...
        Canvas { id:tmpCanvas; anchors.fill:parent; contextType:'2d'; opacity:0.1 }
        Timer { id:gogo; property real startTime; interval:30; repeat:true; onTriggered:previewCanvas.vid.update(new Date-startTime) }
        Timer {
            interval:500; running:true;
            onTriggered: {
                var vid = previewCanvas.vid = new V.Vunsq(previewCanvas,tmpCanvas);
